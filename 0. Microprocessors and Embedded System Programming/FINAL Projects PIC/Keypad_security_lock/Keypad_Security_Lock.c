...
/*
* this is interrupt function where password changing is called
*/
...
/*
* this is main function where code execution start.
*/
void main(void) {
    TRISD=0x00;
    TRISB=0x07;
...
/*
* this is LCD commands function to set LCD
*/
...
/*
* this is LCD data function to sent data to LCD
*/
...
/*
* this is LCD string function to sent string to LCD
*/
...
/*
* this is LCD first setting function
*/
...
/*
* this is EEPROM reading data function
*/
...
/*
* this is EEPROM writing data function
*/
...
/*
* this is password checking function checks
* whether password is right or wrong 
*/
...
void change_pass(void){
    ...
    while(temp_1==keypad()){};
    /*
     * storing values for new password
     */
